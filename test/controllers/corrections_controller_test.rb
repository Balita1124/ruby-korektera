...
class CorrectionsControllerTest < ActionController::TestCase
  ...
  test "should create correction" do
    assert_difference('Correction.count') do
      post :create, correction: { avant: @correction.avant, demande: @correction.demande, description: @correction.description }
    end
  ...
  test "should update correction" do
    patch :update, id: @correction, correction: { avant: @correction.avant, demande: @correction.demande, description: @correction.description }
    assert_redirected_to correction_path(assigns(:correction))
  end
